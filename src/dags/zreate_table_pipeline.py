...
with DAG(
    ...
    insert_data = SQLExecuteQueryOperator(
        ...
        sql=f"""
            USE {DATABASE_NAME};
            INSERT INTO inventory_data (product_id, product_name, stock_level)
    ...
    select_data = SQLExecuteQueryOperator(
        ...
        conn_id=MYSQL_CONN_ID,
        sql=f"SELECT * FROM {DATABASE_NAME}.inventory_data WHERE stock_level > 20;"
    )
